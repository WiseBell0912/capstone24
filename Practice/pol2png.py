...
def pol2png(fileIn, fileOut):
    ...
    print('여기까지')
    # png로 저장
    cv2.imwrite('qwer.jpg', calibrated_imgs)
    print('여기까지')
...
# 0 # 파일 경로
poldir = "/Users/imhyeonjong/Documents/개인/X-Band Radar/폴/"  # .pol파일 경로
pngdir = "/Users/imhyeonjong/Documents/개인/X-Band Radar/폴/"  # png파일 저장 경로
