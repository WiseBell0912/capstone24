...
ANN_SIMULATE_INPUT = [Tp',Tp(idx2)',Tp(idx3)',...
    ...
    noiseMax(idx1)',noiseMax(idx2)',noiseMax(idx3)',...
        windMin(idx1)', windMin(idx2)', windMin(idx3)',...
    windMax(idx1)', windMax(idx2)', windMax(idx3)',...
...
xlim_set = [datetime(2018,11,1) datetime(2019,1,6)];
xlim(xlim_set)
ylim([0 7])
...
% scatter(hs_gpd_tr, ANN_out)

error = ANN_out - hs_tr;

% scatter(ANN_out, hs_tr)
% axis image
% xlim([0 6])
% ylim([0 6])
...
% ylim([0 6])
% 
% exportgraphics(gcf, 'Only_Wind.PNG', 'Resolution', 300)
